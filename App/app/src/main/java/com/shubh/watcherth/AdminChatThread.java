...
import com.shubh.watcherth.util.ChatPOJO;
...
public class AdminChatThread extends AppCompatActivity implements View.OnClickListener{
        ...
        mAdapter = new FirebaseRecyclerAdapter<ChatPOJO, ChatViewHolder>(
            ...
            protected void populateViewHolder(final ChatViewHolder viewHolder,
                ...
                if (mMessage.getMessage() != null && messenger.equals("dispatcher")) {
                    ...
                    viewHolder.tvMessengerThis.setText("Assistant");
    ...
    private void getUi() {
        ...
        switch(title){
            case "Earthquake":
                reportLogo.setImageResource(R.drawable.earthquake);
                break;
            case "Flood":
                reportLogo.setImageResource(R.drawable.flood);
                break;
            case "Volcano":
                reportLogo.setImageResource(R.drawable.volcano);
                break;
            case "Cyclone":
                reportLogo.setImageResource(R.drawable.cyclone);
                break;
            case "Landslide":
                reportLogo.setImageResource(R.drawable.landslide);
                break;
        }
