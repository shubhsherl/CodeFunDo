...
public class CycloneEmergency extends BaseXBeeFragment {
    private static final String REPORT = "report";
    private IncidentReport incidentReport;
    private static final String TAG = "CycloneEmergency";
    private Report cyclone;
    ...
    public CycloneEmergency() {
        // Required empty public constructor
    }

    public static CycloneEmergency newInstance(IncidentReport param1) {
        CycloneEmergency fragment = new CycloneEmergency();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cyclone = incidentReport.getReport(Constant.CYCLONE);
    ...
    public void onButtonClick(int buttonid){
        ...
        switch (buttonid){
            ...
            case R.id.radio_q1_c:
                ...
                if(radio.isChecked()) {
                    cyclone.setSingleChoice(0, new Choice(radio.getText().toString(), null));
                    Log.d(TAG, "is checked " + radio.isChecked());
                }
                else {
                    radio.setChecked(false);
                    Log.d(TAG, "is not checked" + radio.isChecked());
                    cyclone.removeOneChoiceQuestion(0);
                }
                break;
            ...
            case R.id.checkbox_q2_c:
                ...
                if (checkBox.isChecked())
                    cyclone.setMultiChoice(1, new Choice(checkBox.getText().toString(), null));
                else
                    cyclone.removeMultiChoiceQuestion(1, new Choice(checkBox.getText().toString(), null));
                break;
