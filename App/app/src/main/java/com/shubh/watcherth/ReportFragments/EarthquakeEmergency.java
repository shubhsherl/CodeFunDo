...
public class EarthquakeEmergency extends BaseXBeeFragment {
    private static final String REPORT = "report";
    private IncidentReport incidentReport;
    private static final String TAG = "EarthquakeEmergency";
    private Report earthquake;
    ...
    public EarthquakeEmergency() {
        // Required empty public constructor
    }

    public static EarthquakeEmergency newInstance(IncidentReport param1) {
        EarthquakeEmergency fragment = new EarthquakeEmergency();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        earthquake = incidentReport.getReport(Constant.EARTHQUAKE);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        Log.d(TAG, incidentReport.toString());
        getActivity().setTitle("Earthquake");
        setButtonListener();
    }
    ...
    public void onButtonClick(int buttonid){
        ...
        switch (buttonid){
            ...
            case R.id.radio_q1_c:
                ...
                if(radio.isChecked()) {
                    earthquake.setSingleChoice(0, new Choice(radio.getText().toString(), null));
                    Log.d(TAG, "is checked " + radio.isChecked());
                }
                else {
                    radio.setChecked(false);
                    Log.d(TAG, "is not checked" + radio.isChecked());
                    earthquake.removeOneChoiceQuestion(0);
                }
                break;
            ...
            case R.id.checkbox_q2_c:
                ...
                if (checkBox.isChecked())
                    earthquake.setMultiChoice(1, new Choice(checkBox.getText().toString(), null));
                else
                    earthquake.removeMultiChoiceQuestion(1, new Choice(checkBox.getText().toString(), null));
                break;
