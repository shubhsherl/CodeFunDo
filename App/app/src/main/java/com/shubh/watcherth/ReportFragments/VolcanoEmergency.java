...
public class VolcanoEmergency extends BaseXBeeFragment {
    private static final String REPORT = "report";
    private IncidentReport incidentReport;
    private static final String TAG = "VolcanoEmergency";
    private Report volcano;
    ...
    public VolcanoEmergency() {
        // Required empty public constructor
    }

    public static VolcanoEmergency newInstance(IncidentReport param1) {
        VolcanoEmergency fragment = new VolcanoEmergency();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        volcano = incidentReport.getReport(Constant.VOLCANO);
    ...
    public void onButtonClick(int buttonid){
        ...
        switch (buttonid){
            ...
            case R.id.radio_q1_c:
                ...
                if(radio.isChecked()) {
                    volcano.setSingleChoice(0, new Choice(radio.getText().toString(), null));
                    Log.d(TAG, "is checked " + radio.isChecked());
                }
                else {
                    radio.setChecked(false);
                    Log.d(TAG, "is not checked" + radio.isChecked());
                    volcano.removeOneChoiceQuestion(0);
                }
                break;
            ...
            case R.id.checkbox_q2_c:
                ...
                if (checkBox.isChecked())
                    volcano.setMultiChoice(1, new Choice(checkBox.getText().toString(), null));
                else
                    volcano.removeMultiChoiceQuestion(1, new Choice(checkBox.getText().toString(), null));
                break;
